...
/*   Updated: 2025/06/09 13:55:25 by benpicar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 
 * @return	A string indicating that the grade is too high.
 */
 ...
 * @throws	GradeTooLowException if the bureaucrat's grade is too low to sign
 * 			the form.
 */
...
/**
 * @brief	Execute a form if the bureaucrat's grade is high enough and the form
 * 			is signed.
 * 
 * @param	form The form to be executed.
 * @throws	GradeTooLowException if the bureaucrat's grade is too low to execute
 * 			the form.
